var _createClass = function () {function defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}return function (Constructor, protoProps, staticProps) {if (protoProps) defineProperties(Constructor.prototype, protoProps);if (staticProps) defineProperties(Constructor, staticProps);return Constructor;};}();function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}} // Based on the stem generator in Flash Math Creativity
var
EventManager = function () {

  function EventManager() {_classCallCheck(this, EventManager);
    this.eventLookup = {};
  }_createClass(EventManager, [{ key: "off", value: function off(

    event, callback) {
      var listeners = this.eventLookup[event];
      if (event === "*") this.eventLookup = {};else
      if (!callback) this.eventLookup[event] = [];else
      _.remove(listeners, { callback: callback });
    ...
    event, callback, scope) {
      ...
      return function () {return _.remove(listeners, { callback: callback });};
    } }, { key: "once", value: function once(

    event, callback, scope) {var _this = this;
      var on = function on() {for (var _len = arguments.length, data = Array(_len), _key = 0; _key < _len; _key++) {data[_key] = arguments[_key];}
        _this.off(event, on);
    ...
    event) {for (var _len2 = arguments.length, data = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {data[_key2 - 1] = arguments[_key2];}
      var listeners = this.eventLookup[event];
      if (!listeners) return;
...
function generate() {
  ...
  stems.children().each(function () {var _this2 = this;

    var tween = TweenMax.to(this, _.random(2, 4, true), {
      drawSVG: true,
      delay: _.random(2, true),
      onStart: function onStart() {return TweenLite.set(_this2, { opacity: 1 });},
      onUpdate: function onUpdate() {return events.fire(_this2.id, tween.progress());} });
...
function createPlant() {
  ...
  var values = points.map(function (point) {return point.x + "," + point.y;});
